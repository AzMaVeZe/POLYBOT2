# 🎾 Puddle Game — Americano Scoreboard

A simple score-keeping app for a 4-player "puddle" (padel Americano style) tournament.

## How it works

- **4 players** enter their names once, at the start of the tournament.
- Every game is played to a total of **32 points** — the two teams' scores always add up to 32 (e.g. 20–12).
...
- A **game history** lists every game with the teams, winner and score.
